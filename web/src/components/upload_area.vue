  ...
  <div class="upload-area">
    ...
    >
      ...
      <div class="drop-content">
        ...
        >
        <p class="hint">
          Files will be uploaded and named as (user.email-YYYYMMDD_HHMMSS)
        </p>
      </div>
    </div>
...
async function uploadFile(item) {
  ...
  const renamedFile = new File([item.file], filename, { type: item.file.type });

  return await apiUploadFile(renamedFile);
}
